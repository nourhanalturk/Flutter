          ...
          appBar: AppBar(
            ...
            actions: [
              defaultTextButton(text: 'Update', function:(){
                SocialCubit.get(context).updateUser(phone:phoneController.text , bio: bioController.text, name: nameController.text);
              }),
              SizedBox(
                width: 15.0,
              )
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image:profileCover == null
                                          ...
                                          : FileImage(profileCover) as ImageProvider<Object>,
                                      fit: BoxFit.cover
                                  ),
                                )
                            ),
